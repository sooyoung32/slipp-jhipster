...
import net.slipp.jhipster.service.MailService;
import net.slipp.jhipster.service.UserService;
import net.slipp.jhipster.service.dto.UserDTO;
import net.slipp.jhipster.web.rest.vm.KeyAndPasswordVM;
import net.slipp.jhipster.web.rest.vm.ManagedUserVM;
