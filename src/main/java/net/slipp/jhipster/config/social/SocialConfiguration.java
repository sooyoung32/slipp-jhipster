package net.slipp.jhipster.config.social;

import net.slipp.jhipster.repository.SocialUserConnectionRepository;
import net.slipp.jhipster.repository.CustomSocialUsersConnectionRepository;
import net.slipp.jhipster.security.jwt.TokenProvider;
import net.slipp.jhipster.security.social.CustomSignInAdapter;
