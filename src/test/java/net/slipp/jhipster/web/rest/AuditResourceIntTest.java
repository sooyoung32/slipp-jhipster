...
import net.slipp.jhipster.config.audit.AuditEventConverter;
import net.slipp.jhipster.domain.PersistentAuditEvent;
import net.slipp.jhipster.repository.PersistenceAuditEventRepository;
import net.slipp.jhipster.service.AuditEventService;
